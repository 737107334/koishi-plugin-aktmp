...
| 在线状态 / 在线位置（服务器·国家·城市） | Trucky 接口 | TMP 官方无「玩家是否在线」查询，由 Trucky 实时获取（已切换无缓存镜像源，避免旧缓存导致判断不准） |
...
- ✅ 在线状态改用 Trucky 无缓存镜像源（api.114512.xyz），修正在线判断不准问题
